...
//https://app.termsfeed.com/wizard/terms-conditions/#step-4
const PrivayPolicyComponent = () => {
  return (
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Collisio.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Iceland
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Collisio, accessible from
            <a
              href="https://www.collisio.club"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.collisio.club
            </a>
          </p>
        </li>
        <li>
...
export default PrivayPolicyComponent;
